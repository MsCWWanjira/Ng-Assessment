...
exports.TalkativeDirective = void 0;
const core_1 = require("@angular/core");
let TalkativeDirective = (() => {
    ...
    var TalkativeDirective = _classThis = class {
        constructor(el, messageService) {
    ...
    __setFunctionName(_classThis, "TalkativeDirective");
    (() => {
        ...
        TalkativeDirective = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TalkativeDirective = _classThis;
})();
exports.TalkativeDirective = TalkativeDirective;
